...
var searchFields = document.getElementsByClassName('woocommerce-product-search');
        ...
        value: function render() {
            ...
            if (this.props.loading) {
                ...
                var _results = this.props.results.map(function (result) {
                    return _react2.default.createElement(_searchResult2.default, { ley: result.id, result: result });
                });
                results = _react2.default.createElement(
                    'ul',
